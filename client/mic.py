...
class Mic:
    ...
    def passiveListen(self, PERSONA):
        ...
        with tempfile.NamedTemporaryFile(mode='w+b', delete=True, suffix='.wav') as f:
            ...
            ret, feature_file, lld = self._emotion.featurise(f.name, '/tmp/tmpOpenSMILE.arff')
            ...
            ret, xbow_feature_file = self._emotion.featuriseXBOW(lld, '/tmp/tmpOpenXBOW.arff')
            self._logger.debug('Return code from featuriseXBOW: {}'.format(ret))
